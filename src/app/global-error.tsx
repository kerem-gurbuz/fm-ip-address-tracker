  ...
  return (
    <html>
      <body>
        <div
          id="global-error"
          className="flex min-h-screen items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 px-6 py-8 text-gray-100"
        >
          <div className="w-full max-w-md">
            <div className="space-y-8 text-center">
              ...
              <p className="mx-auto max-w-sm text-sm text-gray-500">
                ...
                solution. {error.digest ? `(${error.digest})` : null}
              </p>
